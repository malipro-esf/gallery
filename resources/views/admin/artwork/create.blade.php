        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="m-t-30" action="{{route('artwork.store')}}" method="post"
                        ...
                        <div class="row p-t-20 l-red">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="191" required class="form-control" value="{{old('name_persian')}}"
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="191"  class="form-control" value="{{old('subject_persian')}}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="191"  class="form-control" value="{{old('subject_english')}}"
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="4"  class="form-control" value="{{old('year_created')}}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="images[]" id="images" required accept="image" multiple class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="type" name="idea_type">
                                        <option {{old('idea_type')=='original'?'selected':''}} value="original">{{__('titles.original')}}</option>
                                        <option {{old('idea_type')=='copy'?'selected':''}} value="copy">{{__('titles.copy')}}</option>
                                        <option {{old('idea_type')=='unknown'?'selected':''}} value="unknown">{{__('titles.unknown')}}</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="paint-type" name="paint_type">
                                        <option {{old('paint_type')=='panel'?'selected':''}} value="panel">{{__('titles.panel painting')}}</option>
                                        <option {{old('paint_type')=='mural'?'selected':''}} value="mural">{{__('titles.mural')}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" multiple="multiple" name="techniques[]" id="techniques">
                                        @foreach($categories->where('type','technique') as $style)
                                                <option {{old('techniques')?in_array($style->id,old('techniques'))?'selected':"":''}} value="{{$style->id}}">{{$locale=='fa'?$style->name_persian:$style->name_english}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                    ...
                                    @foreach($attributes as $attr)
                                        <div>
                                            ...
                                            @foreach($attr->values as $value)
                                                <input type="checkbox" name="attrValues[]" {{ old('attrValues')?in_array($value->id, old('attrValues'))?'checked':'':''}} value="{{$value->id}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" multiple="multiple" name="tags[]" id="tags">
                                        @foreach($tags as $tag)
                                            <option  {{old('tags')?in_array($tag->id,old('tags'))?'selected':"":''}} value="{{$tag->id}}">{{$locale=='fa'?$tag->name_persian:$tag->name_english}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control" name="description_persian" placeholder="{{__('titles.enter description in persian')}}"
                                              id="des-persian">{{old('description_persian')}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control" name="description_english" placeholder="{{__('titles.enter description in english')}}"
                                              id="des-english">{{old('description_english')}}</textarea>
                                </div>
                            </div>
                        </div>
