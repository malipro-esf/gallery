                ...
                <div class="card-body">
                    ...
                    <form class="m-t-30" action="{{route('blog.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content_persian" id="content-persian" class="form-control" rows="4">{{old('content_persian')}}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="content-persian">{{__('titles.english content')}}</label>
                            <textarea name="content_english" id="content-english" class="form-control" rows="4">{{old('content_english')}}</textarea>
                        </div>
