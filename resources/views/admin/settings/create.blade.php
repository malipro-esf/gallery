...
@section('content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="m-t-30" action="{{route('settings.store')}}" method="post"
                        ...
                        <div class="row p-t-20 l-red">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="191" required class="form-control" value="{{old('title_persian')}}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="191" required class="form-control" value="{{old('title_english')}}"
    ...
    {{--                                    <h6 class="card-subtitle">CKEditor is an Open source application, which means it can be modified in any way you want. It benefits from an active community that is constantly evolving the application with free add-ons and a transparent development process.</h6>--}}
                                        <div class="form-group">
                                        <textarea name="text_persian" placeholder="{{__('titles.enter text in persian')}}" id="ckeditor" cols="50" rows="15" class="ckeditor">
                                           {{old('text_persian')}}
                                        </textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        {{--                                    <h6 class="card-subtitle">CKEditor is an Open source application, which means it can be modified in any way you want. It benefits from an active community that is constantly evolving the application with free add-ons and a transparent development process.</h6>--}}
                                        <div class="form-group">
                                        <textarea name="text_english" placeholder="{{__('titles.enter text in english')}}" id="ckeditor" cols="50" rows="15" class="ckeditor">
                                           {{old('text_english')}}
                                        </textarea>
                                        </div>
                                    </div>
