        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">{{__('titles.settings')}}</h4>
                    ...
                    <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe"
                        ...
                        <tr class="text-center">
                            ...
                            <th scope="col" data-tablesaw-sortable-col
                                data-tablesaw-priority="persist">{{__('titles.persian title')}}</th>
                            <th scope="col" data-tablesaw-sortable-col
                                data-tablesaw-priority="3">{{__('titles.english title')}}</th>
                            <th scope="col" data-tablesaw-sortable-col
                                data-tablesaw-priority="6">{{__('titles.actions')}}</th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        @foreach($settings as $index => $setting)
                            <tr class="text-center">
                                <td>{{++$index}}</td>
                                <td>{{$setting->title_persian}}</td>
                                <td>{{$setting->title_english}}</td>
                                <td>
                                    <a href="{{route('settings.show',['setting' => $setting])}}" data-toggle="tooltip"
                                       data-placement="top" title="" data-original-title="{{__('titles.show')}}">
                                        <i class="fa fa-eye"></i>
                                    </a>


                                    <a href="{{route('settings.edit',['setting' => $setting])}}" data-toggle="tooltip"
